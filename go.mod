...
replace github.com/go-jose/go-jose/v4 v4.1.0 => github.com/go-jose/go-jose/v4 v4.1.4
...
replace go.opentelemetry.io/otel v1.41.0 => go.opentelemetry.io/otel v1.45.0
