...
- Missing default templates are now considered empty instead of resulting in an error
...
[Unreleased]: https://github.com/giantswarm/konfigure/compare/v0.15.1...HEAD
